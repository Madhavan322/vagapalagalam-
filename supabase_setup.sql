...
-- STEP 3: DATA VISIBILITY POLICIES
...
create policy "Users can delete (unsend) their messages"
...
-- STEP 6: ⚡ REALTIME ACTIVATION (MANDATORY)
-- Enable instant sync for all core social features.
DO $$ 
BEGIN 
    -- Messages
...
-- Optimize for real-time deletions & updates (e.g. Unsend)
